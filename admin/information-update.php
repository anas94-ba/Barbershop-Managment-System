...
if ($_SESSION['csrf_token'] - $_POST["token"] === 0){
	if($_POST['email'] != null) {
		...
		$query=mysqli_query($con,"UPDATE tblinformation SET Email= '$email' , phone ='$phone' , address = '$address', facebook = '$facebook';");		if($query){
...
<body class="cbp-spmenu-push">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
                    ...
                    <?php 
					    $query = mysqli_query($con, "SELECT * FROM tblinformation;");
    ...
    echo $msg;
								...
								<div class="form-group"> 
                                    ...
                                    <label for="sername2">Address</label>
									<input type="text" value='<?php echo $row["address"]?>'  class="form-control" id="sername2" name="address" placeholder="address" required="true"> 
								

								
									<label for="sername3">Facebook</label>
									<input type="text" value='<?php echo $row["facebook"]?>' class="form-control" id="sername3" name="facebook" placeholder="facebook" required="true"> 
