					...
					<table class="table table-bordered" style="text-align: center; "> 
						...
						<tbody>
						 ...
						 <tr> 
							...
							<td >
								<a class="btn btn-danger " style="margin-right: 45px;" title="service-delete.php?id=<?php echo $row['ID']; ?>&token= <?php echo $_SESSION['csrf_token']; ?>">
									Delete
								</a>
								<a class="btn btn-primary" href="service-update-display.php?id=<?php echo $row['ID']?>&price=<?php echo $row['Price']?>&name=<?php echo $row['Name']?>&time=<?php echo $row['Time']?> ">
								   Edit
							    </a>
							</td>
							</tr>   
