...
if(isset($_POST['submit']))
  {
    ...
    if($ret > 0){
		...
		$token = uniqid();
		$_SESSION['confirm_customer_password']=$token;

		$_SESSION['reset_customer_id']=$ret[0]['ID'];
		...
		if(!$mail->send()){
		  $msg = "please return in another time";
			...
			header('location:customer-confirm-password.php');
		}
    }
    else{
		...
		<div id="page-wrapper">
			<div class="main-page login-page ">
				...
				<div class="widget-shadow">
					<div class="login-top">
						<h4>Welcome to reset your password, please enter your email</h4>
					</div>
